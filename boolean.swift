...
public class Boolean : ADT {
    public init(){
      ...
      self.add_operator("or", Boolean.or, [
          Rule(Boolean.or(Boolean.True(), Variable(named:"x")), Boolean.True()), // True or x -> True
          Rule(Boolean.or(Variable(named:"x"), Boolean.True()), Boolean.True()), // x or True -> True
          Rule(Boolean.or(Boolean.False(), Boolean.False()), Boolean.False()) // False or False -> False
      ], ["bool", "bool"])
      
      // TODO: eq (equal)
      self.add_operator("==",Boolean.eq, [
          Rule(Boolean.eq(Boolean.False(), Boolean.False()), Boolean.True()), // False == False -> True
          Rule(Boolean.eq(Boolean.True(), Boolean.True()), Boolean.True()), // True == True -> True
          Rule(Boolean.eq(Boolean.False(), Boolean.True()), Boolean.False()), // False == True -> False
          Rule(Boolean.eq(Boolean.True(), Boolean.False()), Boolean.False()) // True == False -> False
      ], ["bool", "bool"])
    }
